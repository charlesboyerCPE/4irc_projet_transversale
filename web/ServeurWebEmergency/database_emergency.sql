...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 17 déc. 2021 à 14:12
...
CREATE TABLE IF NOT EXISTS `pompier` (
  `id_pompier` int(4) NOT NULL AUTO_INCREMENT,
  `id_caserne` int(4) NOT NULL,
...
--
ALTER TABLE `camion`
  ADD CONSTRAINT `camion_ibfk_1` FOREIGN KEY (`id_caserne`) REFERENCES `caserne` (`id_caserne`);

--
-- Contraintes pour la table `constitution`
--
ALTER TABLE `constitution`
  ADD CONSTRAINT `constitution_ibfk_1` FOREIGN KEY (`id_equipe`) REFERENCES `equipe` (`id_equipe`),
  ADD CONSTRAINT `constitution_ibfk_2` FOREIGN KEY (`id_pompier`) REFERENCES `pompier` (`id_pompier`);
...
ALTER TABLE `operation`
  ADD CONSTRAINT `operation_ibfk_1` FOREIGN KEY (`id_feu`) REFERENCES `feu` (`id_feu`),
  ADD CONSTRAINT `operation_ibfk_2` FOREIGN KEY (`id_camion`) REFERENCES `camion` (`id_camion`),
  ADD CONSTRAINT `operation_ibfk_3` FOREIGN KEY (`id_equipe`) REFERENCES `equipe` (`id_equipe`);

--
-- Contraintes pour la table `pompier`
--
ALTER TABLE `pompier`
  ADD CONSTRAINT `pompier_ibfk_1` FOREIGN KEY (`id_caserne`) REFERENCES `caserne` (`id_caserne`);
COMMIT;
